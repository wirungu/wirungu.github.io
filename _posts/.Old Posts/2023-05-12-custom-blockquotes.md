...
related_posts: true
---
This post shows how (RANDOM TEXT) to add custom styles for blockquotes. Based on [jekyll-gitbook](https://github.com/sighingnow/jekyll-gitbook) implementation.
